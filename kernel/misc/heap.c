...
__attribute__((no_sanitize("undefined"))) struct heap *heap_create(void)
{
...
__attribute__((no_sanitize("undefined"))) void heap_delete(struct heap *h)
{
...
__attribute__((no_sanitize("undefined"))) void *heap_alloc(struct heap *h, uint64_t n)
{
...
__attribute__((no_sanitize("undefined"))) void heap_free(void *ptr)
{
